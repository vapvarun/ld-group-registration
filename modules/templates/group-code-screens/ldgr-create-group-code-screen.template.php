<?php
/**
 * Template : LDGR create group code screen template
 *
 * @since 4.1.0
 * @version 4.3.15
 *
...
?>
<div class="ldgr-group-code-setting ldgr-group-code-create-section">
	<h2 class="ldgr-gcs-heading"><?php printf( esc_html__( 'New %s Code', 'wdm_ld_group' ), \LearnDash_Custom_Label::get_label( 'group' ) ); ?></h2>
	<div class="ldgr-group-code-messages">
		<span class="ldgr-message-close">&times;</span>
		<span class="ldgr-message-text"></span>
	</div>
	<form method="post" id="ldgr-group-code-create-form" class="ldgr-form">
		...
		<div class="ldgr-field ldgr-code-loader">
		...
		<?php wp_nonce_field( 'ldgr-create-group-code-' . get_current_user_id(), 'ldgr_nonce' ); ?>
		<div class="ldgr-eg-actions">
			<span class="ldgr-btn gcs-cancel"><?php esc_html_e( 'Cancel', 'wdm_ld_group' ); ?></span>
			<span class="ldgr-btn ldgr-bg-color solid ldgr-submit-form"><?php esc_html_e( 'Submit', 'wdm_ld_group' ); ?></span>
		</div>
	</form>
</div>
