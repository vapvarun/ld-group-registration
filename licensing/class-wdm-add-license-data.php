...
if ( ! class_exists( 'Licensing\WdmAddLicenseData' ) ) {
	class WdmAddLicenseData {
		...
		public function __construct( $plugin_data ) {
			...
			add_action( 'init', [ $this, 'addData' ], 2 );
			// This action is used to add license menu
			add_action( 'admin_menu', [ $this, 'licenseMenu' ] );
			// This action is used to display plugin on licensing page
			add_action( 'wdm_display_licensing_options', [ $this, 'displayLicensePage' ] );
		}
		...
		public function licensePage() {
			include_once trailingslashit( dirname( __DIR__ ) ) . 'licensing/license-page.php';
		}
